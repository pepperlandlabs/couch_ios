...
- (void)commonInit
{
   ...
   ((CAShapeLayer *)self.layer).fillColor = [UIColor colorWithRed:0.22 green:.62 blue:0.05 alpha:1.0].CGColor;
//    CGColor *white = [UIColor whiteColor].CGColor;
    ...
    self._selectedStainView.backgroundColor = HEXCOLOR(0x000000); //[UIColor colorWithRed:0.816 green:0.816 blue:0.816 alpha:1];
//    HEXCOLOR(0xff424343);[UIColor colorWithRed:66/255 green:67/255 blue:67/255 alpha:1];//66,67,67
...
- (void)insertSegmentWithTitle:(NSString *)title atIndex:(NSUInteger)segment animated:(BOOL)animated
{
    ...
    segmentView.alpha = 0;
    segmentView.text = title;
    segmentView.textColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
    ...
    else
    {
        ...
        completion:^(BOOL finished)
        {
            for (UILabel *item in self._items)
            {
                ...
                {
                    item.textColor = [UIColor whiteColor]; //[UIColor colorWithRed:0.235 green:0.235 blue:0.235 alpha:1];
...
- (void)drawSelectedMaskAtPosition:(CGFloat)position
{
    ...
    if (!_borderBottomLayer)
    {
      ...
      //  _borderBottomLayer.strokeColor = HEXCOLOR(0xff42434);// UIColor.whiteColor.CGColor;
